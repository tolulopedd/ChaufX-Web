...
export const adminInputClass =
  "w-full rounded-2xl border border-[#E5E7EB] bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[#4F46E5] focus:ring-2 focus:ring-[#EEF0FF]";

export const adminPrimaryButtonClass =
  "rounded-2xl bg-[#2563EB] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#1D4ED8] disabled:cursor-not-allowed disabled:opacity-60";
...
export const adminTableCellClass = "px-3 py-2 align-top text-sm text-slate-700";
...
export function EmptyState({
  ...
  return (
    <div className="rounded-[22px] border border-dashed border-[#D7DEEE] bg-[#FBFCFE] px-5 py-5">

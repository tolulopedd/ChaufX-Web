...
export function PublicPageShell({ children, heroTitle, heroCopy, heroTagline, heroActions }: PublicPageShellProps) {
  return (
    <main className="min-h-screen bg-[#F6F8FC]">
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-6 md:px-8">
          ...
          {heroTitle || heroCopy || heroTagline ? (
            <div className="px-1 py-10 md:px-2 md:py-12 lg:py-16">
              <div className="max-w-3xl rounded-[28px] bg-[linear-gradient(135deg,rgba(5,11,21,0.36),rgba(5,11,21,0.08))] p-2 md:p-4">
                {heroTitle ? (
                  <h1 className="text-4xl font-semibold tracking-[-0.06em] text-white [text-shadow:0_6px_28px_rgba(5,11,21,0.85)] md:text-6xl">
                    {heroTitle}
                  </h1>
                ) : null}
                {heroCopy ? (

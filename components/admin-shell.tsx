...
const navSections: NavSection[] = [
  {
    title: "Overview",
    items: [{ href: "/dashboard", label: "Dashboard", icon: DashboardIcon, roles: ["admin"] }]
  },
  {
    title: "Operations",
    items: [
  ...
  {
    title: "Content",
    items: [{ href: "/blog-manager", label: "Blog", icon: BlogIcon, roles: ["admin", "marketing"] }]
  },
  {
    title: "System",
    items: [{ href: "/settings", label: "Settings", icon: SettingsIcon, roles: ["admin"] }]
  }
] as const;
          ...
          <nav className="mt-4 space-y-4">
            {visibleNavSections.map((section) => (
              <div key={section.title}>
                <div className="mb-1.5 px-2.5 text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-slate-400">
                  {section.title}
                </div>
